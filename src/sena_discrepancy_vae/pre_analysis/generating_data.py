...
def generating_data(model_name, latdim, seed):
...
##
model_names = ['full_go_regular', 'full_go_sena_delta_0', 'full_go_sena_delta_1', 'full_go_sena_delta_2', 'full_go_sena_delta_3']
...
for model_name in model_names:
    for latdim in latdims:
        for seed in seeds:
            generating_data(model_name, latdim, seed)        
